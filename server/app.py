...
"""
FastAPI application for the Claude Code For Health Environment.

This module creates an HTTP server that exposes the ClaudeCodeForHealthEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m claude_code_for_health.server.app
    ...
    multiple workers:
        uvicorn claude_code_for_health.server.app:app --workers 4
    """
    import uvicorn
